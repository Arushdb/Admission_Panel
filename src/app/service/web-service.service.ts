...
export class WebServiceService {
  ...
  private getFacultyUrl =
    this.urlName + "admission_panel_server/login/loadEntity.htm";
  private getprogram =
    this.urlName + "admission_panel_server/login/loadProgram.htm";
  private getSemester =
    this.urlName + "admission_panel_server/login/LoadSemester.htm";
  private getBranch =
    this.urlName + "admission_panel_server/login/LoadBranch.htm";
  private getSessionDate =
    this.urlName + "admission_panel_server/login/getSessionDate.htm";
  private generateAdmitCard =
    this.urlName + "admission_panel_server/admitcard/generateAdmitCard.htm";
  private runComputation =
    this.urlName + "admission_panel_server/computation/runComputation.htm";
  private transfer =
    this.urlName + "admission_panel_server/computation/TransferApplication.htm";
  private runComputation01 =
    this.urlName +
    "admission_panel_server/computation/runComputationForAll.htm";
  private meritListProcess =
    this.urlName + "admission_panel_server/computation/meritListProcess.htm";
  private getstudent =
    this.urlName + "admission_panel_server/cca_int/viewData.htm";
  private getstudentView =
    this.urlName + "admission_panel_server/cca_int/viewDataForArbitration.htm";
  private getstudentViewforCounclling =
    this.urlName + "admission_panel_server/cca_int/viewDataForCouncelling.htm";
  private DoOPeration =
    this.urlName + "admission_panel_server/cca_int/DoAction.htm";
  private DoOPerationforBulk =
    this.urlName + "admission_panel_server/cca_int/BulkMarksPosting.htm";
  private DoOPerationforBulk_GD =
    this.urlName + "admission_panel_server/cca_int/BulkMarksPosting_GD.htm";
  private EditRecord =
    this.urlName + "admission_panel_server/cca_int/EditRecord.htm";
  private getStudentData =
    this.urlName + "admission_panel_server/cca_int/viewRecords.htm";
  private getCustomeData =
    this.urlName + "admission_panel_server/computation/getCustomeData.htm";
  private UpdateSCLcomponent =
    this.urlName + "admission_panel_server/computation/UpdateSCLcomponent.htm";
  private UpdateFinalCandidate =
    this.urlName +
    "admission_panel_server/computation/UpdateFinalCandidate.htm";
  private uu1 = this.urlName + "admission_panel_server/computation/uploads.htm";
  private uploadETMarks =
    this.urlName + "admission_panel_server/cca_int/UploadET.htm";
  private EditETMarks =
    this.urlName + "admission_panel_server/cca_int/EditET.htm";
  private distETMarks =
    this.urlName + "admission_panel_server/computation/distributETMarks.htm";

  // Added by Arush on 17-06-2024
  private url_getapplicantmarks =
    this.urlName + "admission_panel_server/verifymarks/getapplicantmarks.htm";
  private url_updatestatus =
    this.urlName + "admission_panel_server/verifymarks/updatestatus.htm";
  private url_validateIWlist =
    this.urlName + "admission_panel_server/verifymarks/validateiwlist.htm";
  ...
  checkLogin(f) {
    ...
    return this.http.post(this.url, para, this.httpOption);
  }
  ...
  getStudent() {
    ...
    return this.http.post(this.getStudentData, para, this.httpOption);
  }
  ...
  getStudentMarks(val) {
    ...
    return this.http.post(this.getCustomeData, para, this.httpOption);
  }
  ...
  transferApplication(app, pid1, pid2, pid3, count) {
    ...
    return this.http.post(this.transfer, para, this.httpOption);
  }
  ...
  updateStudentMarksinSCL(val) {
    ...
    return this.http.post(this.UpdateSCLcomponent, para, this.httpOption);
  }
  ...
  updateFinalCandidate(val1, val2, val3) {
    ...
    return this.http.post(this.UpdateFinalCandidate, para, this.httpOption);
  }
  ...
  getStdentInfoforViewCouncelling(val) {
    ...
    return this.http.post(
      this.getstudentViewforCounclling,
      para,
      this.httpOption
    );
  }
  ...
  EditMarks(val, app) {
    ...
    return this.http.post(this.EditRecord, para, this.httpOption);
  }
  ...
  barcodeTesting(f) {
    ...
    return this.http.post(this.url1, para, this.httpOption);
  }
  ...
  getOwnerFaculty() {
    ...
    return this.http.post(this.getFacultyUrl, para, this.httpOption);
  }
  ...
  getSession() {
    ...
    return this.http.post(this.getSessionDate, para, this.httpOption);
  }
  ...
  genAdmitCard() {
    ...
    return this.http.post(this.generateAdmitCard, para, this.httpOption);
  }
  ...
  runComputationProcess() {
    ...
    return this.http.post(this.runComputation, para, this.httpOption);
  }
  ...
  BulkMarksProcess(val) {
    ...
    return this.http.post(this.DoOPerationforBulk, para, this.httpOption);
  }
  ...
  runComputationProcess01() {
    ...
    return this.http.post(this.runComputation01, para, this.httpOption);
  }
  ...
  runMeritListProcess() {
    ...
    return this.http.post(this.meritListProcess, para, this.httpOption);
  }
  ...
  getOwnerProgram(val) {
    ...
    return this.http.post(this.getprogram, para, this.httpOption);
  }
  ...
  getOwnerSemesterCMS(val) {
    ...
    return this.http.post(this.getSemester, para, this.httpOption);
  }
  ...
  getOwnerBranchCMS(val) {
    ...
    return this.http.post(this.getBranch, para, this.httpOption);
  }
  ...
  uploadMarks() {
    ...
    return this.http.post(this.uploadETMarks, para, this.httpOption);
  }
  ...
  getApplicantMarks(appno: string) {
    ...
    return this.http.post(this.url_getapplicantmarks, para, this.httpOption);
  }
