...
// urlName="https://admission.dei.ac.in:8088/";
 urlName="http://localhost:8080/";
  private url=this.urlName+"my_admission_panel_server/login/checkLogin.htm";
  private url1=this.urlName+"my_admission_panel_server/login/barCode.htm";
  private getFacultyUrl=this.urlName+"my_admission_panel_server/login/loadEntity.htm";
  private getprogram = this.urlName+"my_admission_panel_server/login/loadProgram.htm";
  private getSemester = this.urlName+"my_my_admission_panel_server_server/login/LoadSemester.htm";
  private getBranch = this.urlName+"my_admission_panel_server/login/LoadBranch.htm";
  private getSessionDate =this.urlName+"my_admission_panel_server/login/getSessionDate.htm";
  private generateAdmitCard =this.urlName+"my_admission_panel_server/admitcard/generateAdmitCard.htm"
  private runComputation =this.urlName+"my_admission_panel_server/computation/runComputation.htm";
  private transfer = this.urlName+"my_admission_panel_server/computation/TransferApplication.htm";
  private runComputation01 =this.urlName+"my_admission_panel_server/computation/runComputationForAll.htm";
  private meritListProcess =this.urlName+"my_admission_panel_server/computation/meritListProcess.htm"
  private getstudent =this.urlName+"my_admission_panel_server/cca_int/viewData.htm";
  private getstudentView =this.urlName+"my_admission_panel_server/cca_int/viewDataForArbitration.htm";
  private getstudentViewforCounclling =this.urlName+"my_admission_panel_server/cca_int/viewDataForCouncelling.htm";
  private DoOPeration =this.urlName+"my_admission_panel_server/cca_int/DoAction.htm";
  private DoOPerationforBulk =this.urlName+"my_admission_panel_server/cca_int/BulkMarksPosting.htm";
  private DoOPerationforBulk_GD =this.urlName+"my_admission_panel_server/cca_int/BulkMarksPosting_GD.htm";
  private EditRecord =this.urlName+"my_admission_panel_server/cca_int/EditRecord.htm";
private getStudentData =this.urlName+"my_admission_panel_server/cca_int/viewRecords.htm";
private getCustomeData =this.urlName+"my_admission_panel_server/computation/getCustomeData.htm";
private UpdateSCLcomponent =this.urlName+"my_admission_panel_server/computation/UpdateSCLcomponent.htm";
private UpdateFinalCandidate=this.urlName+"my_admission_panel_server/computation/UpdateFinalCandidate.htm";
private uu1=this.urlName+"my_admission_panel_server/computation/uploads.htm";
  private uploadETMarks=this.urlName+"my_admission_panel_server/cca_int/UploadET.htm";
  private EditETMarks=this.urlName+"my_admission_panel_server/cca_int/EditET.htm";
  private distETMarks=this.urlName+"my_admission_panel_server/computation/distributETMarks.htm";
  
  // Added by Arush on 17-06-2024
  private url_getapplicantmarks=this.urlName+"my_admission_panel_server/verifymarks/getapplicantmarks.htm";
  private url_updatestatus=this.urlName+"my_admission_panel_server/verifymarks/updatestatus.htm";
  private url_validateIWlist=this.urlName+"my_admission_panel_server/verifymarks/validateiwlist.htm";
