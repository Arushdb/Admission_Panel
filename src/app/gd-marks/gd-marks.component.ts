...
import { ViewCertificateComponent } from '../cca-panel/view-certificate/view-certificate.component';

@Component({
  selector: 'app-gd-marks',
  templateUrl: './gd-marks.component.html',
  styleUrls: ['./gd-marks.component.css']
})
export class GdMarksComponent implements OnInit {
  ...
  toggleCandidateList() {
    ...
    validateIWlist(){
      this.myservice.validatefromIWlistGD(this.myAppno).subscribe(
        res=>{
    ...
    EnterMarks()
    {
      ...
      if(+marks<=20)
      {
        ...
        this.myservice.insertMarksGD(this.marks,this.myAppno,this.selectedProgramId
          ...
          responce =>
            {
              this.studentInfo =Array.from(Object.keys(responce), k=>responce[k]);
               ...
               this.applicantName = '';
               this.marks = null;
                alert(" GD marks entered successfully");
      ...
      else
      {
        ...
        alert(" GD marks must be equal or less than 20");
      }
    }
